<form id="form-edit">
    ...
    <div class="modal-body">
        ...
        <div>
            <label for="category-edit" class="form-label">Category <span class="text-danger">*</span></label>
            <input type="text" class="form-control category" id="category-edit" name="category" value="{{ $data->category }}">
            <p id="error-message-category" style="font-size: 12px;"></p>
        </div>
    </div>
